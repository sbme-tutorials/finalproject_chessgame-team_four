        ...
        /*if (selectedPiece!=null) {
            for (int r = 0; r < rows; r++) {
                for (int c = 0; c < cols; c++) {
                    ...
                    if (selectedPiece.isValidMovement(c, r) && getPiece(c, r) != null && selectedPiece.is_white == getPiece(c, r).is_white && !(selectedPiece.row == r && selectedPiece.col == c) && !(selectedPiece.moveCollidesWithPiece(c, r))) {
                        g2d.setColor(new Color(232, 23, 35, 129));
                        g2d.fillRect(c * tilesize, r * tilesize, tilesize, tilesize);
                    }
                    if (selectedPiece.isValidMovement(c, r) && selectedPiece.name.equals("King") && checkScanner.isKingChecked(new Move(this, selectedPiece, c, r))) {
                        g2d.setColor(new Color(232, 23, 35, 129));
                        g2d.fillRect(c * tilesize, r * tilesize, tilesize, tilesize);
                    }
                }
